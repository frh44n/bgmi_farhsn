...
CREATOR = "This File Is Made By @aric_farhan"
...
def verify():
    ...
    if computed_hash != stored_hash:
        raise Exception("This File Is Made By @aric_farhan.")
    print("This File Is Made By @aric_farhan; its_threads.")
...
def send_owner_info(message):
    owner_message = "This Bot Has Been Developed By @aric_farhan; its_threads"
